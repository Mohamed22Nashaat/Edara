...
import '../style/StephenKingAdminProductCard.css';
import { Link } from 'react-router-dom';

 const StephenKingAdminProductCard = (props) =>{
        ...
        <div className="stephen-king-admin-product-card">
            ...
            <div className="stephen-king-admin-product-card-info">
                ...
                <div className="stephen-king-admin-product-card-operation">
                   ...
                   {/* <Link to={'/stephen-view'} className="stephen-king-admin-product-card-view">View</Link> */}
...
export default StephenKingAdminProductCard